...
class DetectionTransformer(BaseDetector, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        checkpoint0=backbone['init_cfg']['checkpoint'][0]
        checkpoint1=backbone['init_cfg']['checkpoint'][1]
        checkpoint2=backbone['init_cfg']['checkpoint'][2]
        checkpoint3=backbone['init_cfg']['checkpoint'][3]
        checkpoint4=backbone['init_cfg']['checkpoint'][4]
        checkpoint5=backbone['init_cfg']['checkpoint'][5]
        backbone['init_cfg']['checkpoint']=checkpoint0
        self.backbone = MODELS.build(backbone)
        backbone['init_cfg']['checkpoint']=checkpoint1
        self.backbone1 = MODELS.build(backbone)
        backbone['init_cfg']['checkpoint']=checkpoint2
        self.backbone2 = MODELS.build(backbone)
        backbone['init_cfg']['checkpoint']=checkpoint3
        self.backbone3 = MODELS.build(backbone)
        backbone['init_cfg']['checkpoint']=checkpoint4
        self.backbone4 = MODELS.build(backbone)
        backbone['init_cfg']['checkpoint']=checkpoint5
        self.backbone5 = MODELS.build(backbone)
        # breakpoint()
        if neck is not None:
    ...
    def extract_feat(self, batch_inputs: Tensor) -> Tuple[Tensor]:
        ...
        """
        x = self.backbone(batch_inputs)#original feature
